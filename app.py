...
class SegmentationEngine:
    def __init__(self):
        ...
        self.seg = mp.solutions.selfie_segmentation.SelfieSegmentation(
            model_selection=1
        )
    ...
    def get_mask(self, frame_bgr):
        ...
        # Reuse previous mask every alternate frame
...
class PortalBox:
    ...
    def update(self, info: dict):
        ...
        # --------------------------------------------
        # Portal box based on both index fingers
        # --------------------------------------------
        ...
        # IMPORTANT:
        # Pinch no longer changes invisibility.
        # Invisibility is controlled from main.py
...
class HUD:
    ...
    def __init__(self, h, w, dev_str):
        ...
        self._fps_buf = collections.deque(
            maxlen=30
        )
